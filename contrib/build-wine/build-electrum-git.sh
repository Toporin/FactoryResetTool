...
info "Pip installing FactoryResetTool. This might take a long time if the project folder is large."
...
wine "$PYHOME/scripts/pyinstaller.exe" -cF --clean --name $NAME_ROOT-$VERSION-console.exe --additional-hooks-dir=. --add-data "../../factory-reset-tool/*.png;." "../../factory-reset-tool/factory-reset-tool.py" -i "../../factory-reset-tool/satochip.ico" 
wine "$PYHOME/scripts/pyinstaller.exe" -wF --clean --name $NAME_ROOT-$VERSION.exe --additional-hooks-dir=. --add-data "../../factory-reset-tool/*.png;." "../../factory-reset-tool/factory-reset-tool.py" -i "../../factory-reset-tool/satochip.ico" 
...
sha256sum dist/FactoryResetTool*.exe
