...
APPDIR="$BUILDDIR/factory-reset-tool.AppDir" #APPDIR="$BUILDDIR/electrum.AppDir" #todo
...
APPIMAGE="$DISTDIR/FactoryResetTool-$VERSION-x86_64.AppImage" #APPIMAGE="$DISTDIR/electrum-$VERSION-x86_64.AppImage"
...
#todo
info "installing FactoryResetTool and its dependencies."
...
# for deterministic build use instead:
...
info "installing FactoryResetTool."
...
cp "$PROJECT_ROOT/factory-reset-tool.desktop" "$APPDIR/factory-reset-tool.desktop"
cp "$PROJECT_ROOT/satochip.png" "$APPDIR/satochip.png"
